...
def addAgent(playground: Playground):
...
def addApple(playground: Playground, agent: ReverseHeadAgent):
    # Initialization of apple (reversing of X or Y controls for agent will occur to agent on collision)
    apple = Apple(agent, reverse_x=False, reverse_y=False)
